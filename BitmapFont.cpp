...
BitmapFont::BitmapFont(Engine * engine, const string & file, int size ) : mEngine(engine) {
	...
	if ( gft_font_create( file.c_str( ), size * mEngine->GetRenderer()->GetGUIWidthScaleFactor( ), GFT_DEFAULT, symbolSet, &mFont ) != GFT_NO_ERROR ) {
