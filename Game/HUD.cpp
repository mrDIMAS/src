...
HUD::HUD() :
	...
	mStealthBar = unique_ptr<GUIBar>(new GUIBar(mGUIScene, ruTexture::Request("data/gui/stealth.png"), ruVirtualScreenWidth - 170, ruVirtualScreenHeight - 80, 150, 17, 0, 100, 100, pGUIProp->mForeColor, false));
	mNoiseBar = unique_ptr<GUIBar>(new GUIBar(mGUIScene, ruTexture::Request("data/gui/noise.png"), ruVirtualScreenWidth - 170, ruVirtualScreenHeight - 60, 150, 17, 0, 100, 100, pGUIProp->mForeColor, false));
